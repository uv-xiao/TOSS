...
const messages: Record<UiLocale, Record<string, string>> = {
  en: {
    ...
    "settings.templateEnabled": "Template enabled",
    "settings.templateDisabled": "Template disabled",
    "settings.templateHint": "When enabled, opening this project uses template copy flow.",
  ...
  "zh-CN": {
    ...
    "settings.templateEnabled": "模板已启用",
    "settings.templateDisabled": "模板已禁用",
    "settings.templateHint": "启用后，打开该项目默认进入模板复制流程。",
